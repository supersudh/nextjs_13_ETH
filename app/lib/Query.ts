...
class Query {
  ...
  static GRAPHQL_URL = 'https://graphql.bitquery.io' || 'https://streaming.bitquery.io/graphql';

  buildHeadersObject() {
    return {
      'Content-Type': 'application/json',
      'X-API-KEY': process.env.NEXT_PUBLIC_BITQUERY_V2_API_KEY,
      'Authorization': `Bearer ${process.env.NEXT_PUBLIC_BITQUERY_V2_ACCESS_TOKEN}`
    };
  }
